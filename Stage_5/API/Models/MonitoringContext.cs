...
namespace API.Models
{
    public partial class MonitoringContext : DbContext
    {
        ...
        public virtual DbSet<VGetCrossProfileUrls> VGetCrossProfileUrls { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=DESKTOP-0IKC9M0;Database=Monitoring;Trusted_Connection=True;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VGetCrossProfileUrls>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("v_GetCrossProfileUrls");
